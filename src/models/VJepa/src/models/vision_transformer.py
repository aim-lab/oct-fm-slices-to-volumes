...
from src.models.VJepa.src.models.utils.patch_embed import PatchEmbed, PatchEmbed3D
from src.models.VJepa.src.models.attentive_pooler import AttentiveClassifier
from src.models.VJepa.src.models.utils.modules import Block
from src.models.VJepa.src.models.utils.pos_embs import get_2d_sincos_pos_embed, get_3d_sincos_pos_embed
from src.models.VJepa.src.utils.tensors import trunc_normal_
from src.models.VJepa.src.masks.utils import apply_masks
...
class LinearHead(nn.Module):
    ...
    def __init__(self, input_size, output_size, head_drop_rate):
        super().__init__()
...
class Vjepa(nn.Module):
    ...
    def __init__(self, num_classes, freeze_backbone):
        ...
        self.encoder = VisionTransformer.from_pretrained("nielsr/vit-large-patch16-v-jepa")  #TODO: remove hardcoding

        if freeze_backbone:
            self.encoder.fc_norm = None #We don't use mean pooling in this case
            ...
            self.classifier = LinearHead(self.encoder.embed_dim,num_classes,0.5)
